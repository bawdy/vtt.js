...
var parseStyle = require('./parse-style.js');
  ...
  try {
    ...
    while (self.buffer) {
      ...
      case "HEADER":
        ...
        continue;
      // case "STYLE":         // TODO: Currently only supports a single style block, which doesn't match spec.
      //   if (!line) {
      //     self.state = "NOTE";
      //   } else {
      //     parseStyle(line);   // Arrived from "ID" case. First line ("STYLE") is already consumed.
      //   }
      //   continue;
      case "NOTE":
        // Ignore NOTE blocks.
